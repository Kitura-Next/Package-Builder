[![Build Status](https://travis-ci.org/Kitura-Next/Package-Builder.svg?branch=develop)](https://travis-ci.org/Kitura-Next/Package-Builder)
...
For example, see the [current test coverage](https://codecov.io/gh/Kitura-Next/Swift-cfenv) for the [Swift-cfenv](https://github.com/Kitura-Next/Swift-cfenv) package.
...
Feel free to read the source for more info: [sonarcloud.sh](https://github.com/Kitura-Next/Package-Builder/blob/master/sonarcloud.sh#L69)
